...
- Determinar a existência de associação entre biomarcadores ou perfil molecular com diagnóstico de COVD-19 e severidade da apresentação clínica por forma a compreender que factores estão associados a uma maior severidade da apresentação clínica desta doença;
...
- 4 scores de severidade da apresentação clínica da doença:
    - hospital-free days at day 45 (HFD-45), em que é atribuido um score com valor zero a doentes que permaneceram internados mais de 45 dias ou morreram durante o internamento, e valores de score mais elevados a doentes com internamentos hospitalares de menor duração e severidade da doença menor;
...
Dados de expressão normalizados (transcripts per kilobase million, TPM) provenientes de RNA-sequencing (Illumina NovaSeq6000) de amostras de sangue destes doentes.
A matrix de contagem de genes por amostra foi descarregada directamente do site GEO (ftp://ftp.ncbi.nlm.nih.gov/geo/series/GSE157nnn/GSE157103/suppl/GSE157103%5Fgenes%2Etpm%2Etsv%2Egz).
